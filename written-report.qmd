...
grid.arrange(p10, p8, ncol = 2)
grid.arrange(p4, p7, ncol = 2)
grid.arrange(p5, p12, ncol = 2)
...
$$
Logit(p) = -0.2812 + 2.8255 \times \beta_{universitypublic} + 3.1011 \times \beta_{universitystem\_priv} \\
- 1.0489 \times \beta_{demo\_race} - 1.0363 \times \beta_{threshold\_gpalow} \\
- 0.0063 \times \beta_{TotalSleepTime} - 0.6819 \times \beta_{daytime\_sleep\_lvllow}
$$
