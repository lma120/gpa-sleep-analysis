...
vif(university_final) #can do this bcs no interaction effects anymore? 
...
$$
logit(p_{high\_gpa}) = 4.206 - 2.825 \times universitycath\_priv \\ + 0.276 \times universitystem\_priv \\
