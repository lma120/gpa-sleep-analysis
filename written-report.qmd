...
data_ur1 <- tibble(demo_race = 1, university = "stem_priv", threshold_gpa = "high")
predict.glm(sig_fit, data_ur1, type = "response")

data_ur2 <- tibble(demo_race = 1, university = "cath_priv", threshold_gpa = "high")
predict.glm(sig_fit, data_ur2, type = "response")
#why is it so low lol

data_ur3 <- tibble(demo_race = 1, university = "public", threshold_gpa = "high")
...
-   how to dtermine which variables to use in fitted model? trial and error or vif or other methods since we have so many
